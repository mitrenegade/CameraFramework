...
-(void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:highResImage forKey:@"highResImage"];
    [aCoder encodeObject:highResImage forKey:@"thumbnail"];
    
    [aCoder encodeObject:pfObjectID forKey:@"pfObjectID"];
    [aCoder encodeObject:imageURL forKey:@"imageURL"];
    [aCoder encodeObject:stixLayerURL forKey:@"stixLayerURL"];
    [aCoder encodeObject:highResImageURL forKey:@"highResImageURL"];
...
-(id)initWithCoder:(NSCoder *)aDecoder {
    ...
    if ((self = [super init])) {
        ...
        [self setHighResImage:[aDecoder decodeObjectForKey:@"highResImage"]];
        [self setThumbnail:[aDecoder decodeObjectForKey:@"thumbnail"]];
        
        [self setPfObjectID:[aDecoder decodeObjectForKey:@"pfObjectID"]];
        [self setImageURL:[aDecoder decodeObjectForKey:@"imageURL"]];
        [self setStixLayerURL:[aDecoder decodeObjectForKey:@"stixLayerURL"]];
        [self setHighResImageURL:[aDecoder decodeObjectForKey:@"highResImageURL"]];
...
-(UIImage*)thumbnail {
    if (!thumbnail)
    {
        ...
        [self setThumbnail:[largeImage resizedImage:CGSizeMake(THUMBNAIL_SIZE, THUMBNAIL_SIZE) interpolationQuality:kCGInterpolationHigh]];
    }
    return thumbnail;
}
...
-(UIImage *)tagToUIImageUsingBase:(BOOL)includeBaseImage retainStixLayer:(BOOL)retainStixLayer useHighRes:(BOOL)useHighRes {
    ...
    // set size of canvas
    CGSize newSize;
    if (useHighRes && self.highResImage) {
